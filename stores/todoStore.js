module.exports = {
  ...
  mutators: {
    addTodo: function(context, data, text) {
    ...
    changeTodo: function(context, data, index, text) {
    ...
    removeTodo: function(context, data, index) {
      if (index >= 0 && data.length > index) {
        // also just a mutable call!
        data.splice(index, 1);
        return data;
      }
